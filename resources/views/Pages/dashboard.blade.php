...
<body class="font-Poppins overflow-x-hidden">
    <div class="flex">
        ...
        <div class="drop-shadow-md">
            <div id="sidebarNav-cont" class="w-[17em] h-[100%] bg-white flex justify-center left-0">
                @livewire('sidebar-navigation')
            </div>
        </div>
        <!--End of Sidebar-->
        <div class="p-6 w-screen bg-gray-50">
            <!--Header-->
            <div class="flex justify-between items-center shadow-lg rounded-lg p-4">
                ...
                <div class="flex justify-center items-center bg-green-500 w-[25dvh] h-[7dvh] rounded-lg">
                    <h1 class="text-white font-bold text-sm">Generate Report</h1>
                </div>
            </div>
            ...
            <div class="w-full flex justify-between mt-4">
                <div class="flex flex-col">
                    <div class="shadow-lg p-4 rounded-lg">
                        <div class="relative bg-red-500 w-[100dvh] h-[12dvh] rounded-lg shadow-lg
                        ...
                        <div class="my-5 flex items-center">
                            <h1 class="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-green-700 drop-shadow-md ">Mode Status:</h1>
                        ...
                        <div class="my-2">
                            <div class="flex items-center">
                                <h1 class="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-green-700 drop-shadow-md my-2">Activate Devices</h1>
                        ...
                        ml-2">
                            ...
                            <!-- Activate Devices -->
                            <div class="w-[70dvh] flex justify-between">
                    ...
                    <!-- Sensors Data -->
                    <div class="w-full my-8 p-4 rounded-lg shadow-lg h-[50dvh]">
